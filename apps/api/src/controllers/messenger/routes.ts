...
router.get('/jokes/:id', [strategy.isAuthenticated], controller.jokesApiProxyMiddleware);

/* Proxy to the KITSU Manga API */
router.get('/manga', [strategy.isAuthenticated], controller.mangaApiProxyMiddleware);
